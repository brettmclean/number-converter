...
ScientificNotationMapper.prototype.toDecimal = function(snStr) {
	this._superProto.toDecimal.apply(this, arguments);
	this._exponent = this._coefficient = 0;

	var snParts = snStr.split("e");
	this._coefficient = parseFloat(snParts[0]);
	this._exponent = parseInt(snParts[1]);
